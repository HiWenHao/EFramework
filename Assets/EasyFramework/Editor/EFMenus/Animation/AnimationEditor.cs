        ...
        foreach (var obj in _objects)
        {
            ...
            if (Directory.Exists(path))
            {
                ...
                foreach (FileInfo file in files)
                {
                    ...
                    {
                        AnimationClip _clip = AssetDatabase.LoadAssetAtPath<AnimationClip>(file.FullName.Substring(file.FullName.IndexOf("Assets")));
            ...
            {
                AnimationClip _clip = AssetDatabase.LoadAssetAtPath<AnimationClip>(path.Substring(path.IndexOf("Assets")));
                if (!_clip)
                {
