...
namespace EasyFramework.Managers
{
    ...
    /// Sources manager.
    /// </summary>
    public class SourceManager : MonoSingleton<SourceManager>, ISingleton, IManager
    {
        ...
        void ISingleton.Init()
        {
            ...
            m_as_BGM = gameObject.AddComponent<AudioSource>();
        ...
        {
            GameObject _obj = new GameObject("AudioSourceItem" + transform.childCount);
