...
namespace EasyFramework.Control
{
    /// <summary>
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        void FixedUpdate()
        {
            ...
            var ss = squaretocircle(transform.forward * EF.Input.Speed_Forward + transform.right * EF.Input.Speed_Right) * m_flt_MoveSpeed * m_flt_SpeedRate;
