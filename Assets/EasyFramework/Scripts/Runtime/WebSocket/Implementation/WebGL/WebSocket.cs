...
namespace EasyFramework.UnityWebSocket
{
    public class WebSocket : IWebSocket
    {
        ...
        internal void HandleOnError(string msg)
        {
            ...
            OnError?.Invoke(new ErrorEventArgs(msg));
        }
        ...
        {
            D.Log($"[EasyFramework.UnityWebSocket]" +
