 ...
 * ModifyTime:    2025-09-30 15:09:57
 * ScriptVersion: 0.1
 * ===============================================
*/
using System;
...
namespace EasyFramework.Edit
{
    ...
    public static class StartProgram
    {
        ...
        static void Startprogram(string programPath, string programName, string arguments = "")
        {
            try
            {
                System.Diagnostics.Process myprocess = new System.Diagnostics.Process();
                myprocess.StartInfo = new System.Diagnostics.ProcessStartInfo(programPath + "/" + programName, arguments)
                {
