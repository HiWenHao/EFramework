...
public sealed partial class Item : Luban.BeanBase
{
    public Item(ByteBuf _buf) 
    {
        ...
        ExchangeStream = global::cfg.Example.ItemExchange.DeserializeItemExchange(_buf);
        {int n0 = _buf.ReadSize(); ExchangeList = new System.Collections.Generic.List<Example.ItemExchange>(n0);for(var i0 = 0 ; i0 < n0 ; i0++) { Example.ItemExchange _e0;  _e0 = global::cfg.Example.ItemExchange.DeserializeItemExchange(_buf); ExchangeList.Add(_e0);}}
        ExchangeColumn = global::cfg.Example.ItemExchange.DeserializeItemExchange(_buf);
    }
