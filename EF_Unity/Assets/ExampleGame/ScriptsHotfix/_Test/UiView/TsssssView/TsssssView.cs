 ...
 * Author:        Alvin8412
 * CreationTime:  2026-04-09 14:41:30
 * ModifyAuthor:  Alvin8412
 * ModifyTime:    2026-04-09 14:41:30
 * ScriptVersion: 0.1 
 * ================================================
 */
...
namespace EFExample
{
    ...
    public partial class TsssssView : IUiView
    {
        public static TsssssView Open(params object[] args)
        {
            return EF.Ui.OpenPageView<TsssssView>(args);
        }

        public static bool Close(params object[] args)
        {
            return EF.Ui.CloseView<TsssssView>(args);
        }
