...
namespace EFExample
{
    ...
    public class GameStart : MonoBehaviour
    {
        ...
        private async UniTask CheckUpdate(EPlayMode playMode)
        {
            ...
            Transform uiViewRect = EF.Assets.Load<Transform>(EF.Projects.AppConst.UIPrefabsPath + "PatchUpdater")
                .transform;
        ...
        {
            return JSON.Parse(System.IO.File.ReadAllText($"{Application.dataPath}/Luban/Json/{file}.json",
