...
namespace EasyFramework.Windows.AssetChecker
{
    ...
    {
        internal string AssetDesc = LC.Combine(new Lc[] { Lc.Assets, Lc.Description });
    ...
    internal class TextureSetting : SettingBase
    {
        ...
        internal override void OnGUI()
        {
            ...
            MipMaps = GUILayout.Toggle(MipMaps, LC.Combine(Lc.Open));
        }
    ...
    internal class ModelSetting : SettingBase
    {
        ...
        internal override void OnGUI()
        {
            ...
            GUILayout.Space(30);
            MaxTriangs = EditorGUILayout.IntSlider(LC.Combine(new Lc[] { Lc.Model, Lc.Max, Lc.Triangular, Lc.Count }), MaxTriangs, 1, AssetsCheckerConfig.ModelMaxTriangs);
            GUILayout.FlexibleSpace();
            MaxBones = EditorGUILayout.IntSlider(LC.Combine(new Lc[] { Lc.Model, Lc.Max, Lc.Bone, Lc.Count }), MaxBones, 1, AssetsCheckerConfig.ModelMaxBones);
