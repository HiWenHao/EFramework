...
namespace EasyFramework.Managers
{
    ...
    public class EventsManager : Singleton<EventsManager>, ISingleton
    {
        ...
        Dictionary<string, IEventsHelp> _eventCenter;
        void ISingleton.Init()
        {
            _eventCenter = new Dictionary<string, IEventsHelp>();
        }
        ...
        public void AddEvent(string eventName, Action action)
        {
            if (_eventCenter.TryGetValue(eventName, out var e))
            {
                if (e.ParamsNumber == 0)
                {
                    (e as EventsHelp).AddAction(action);
                }
                else
            ...
            {
                _eventCenter.Add(eventName, new EventsHelp(action));
            }
        }
        ...
        public void AddEvent<T1>(string eventName, Action<T1> action)
        {
            if (_eventCenter.TryGetValue(eventName, out var e))
            {
                if (e.ParamsNumber == 1)
                {
                    (e as EventsHelp<T1>).AddAction(action);
                }
                else
            ...
            {
                _eventCenter.Add(eventName, new EventsHelp<T1>(action));
            }
        }
        ...
        public void AddEvent<T1, T2>(string eventName, Action<T1, T2> action)
        {
            if (_eventCenter.TryGetValue(eventName, out var e))
            {
                if (e.ParamsNumber == 2)
                {
                    (e as EventsHelp<T1, T2>).AddAction(action);
                }
                else
            ...
            {
                _eventCenter.Add(eventName, new EventsHelp<T1, T2>(action));
            }
        }
        ...
        public void AddEvent<T1, T2, T3>(string eventName, Action<T1, T2, T3> action)
        {
            if (_eventCenter.TryGetValue(eventName, out var e))
            {
                if (e.ParamsNumber == 3)
                {
                    (e as EventsHelp<T1, T2, T3>).AddAction(action);
                }
                else
            ...
            {
                _eventCenter.Add(eventName, new EventsHelp<T1, T2, T3>(action));
            }
        }
        ...
        public void CallEvent<T1, T2>(string eventName, T1 value1, T2 value2)
        {
            ...
            {
                if (e.ParamsNumber == 2)
                    (e as EventsHelp<T1, T2>)?.Call(value1, value2);
                else
        ...
        public void CallEvent<T1, T2, T3>(string eventName, T1 value1, T2 value2, T3 value3)
        {
            ...
            {
                if (e.ParamsNumber == 3)
                    (e as EventsHelp<T1, T2, T3>)?.Call(value1, value2, value3);
                else
        ...
        public void RemoveEvent<T1>(string eventName, Action<T1> action)
        {
            ...
            {
                if (e.ParamsNumber == 1)
                    (e as EventsHelp<T1>).Remove(action);
                else
        ...
        public void RemoveEvent<T1, T2>(string eventName, Action<T1, T2> action)
        {
            ...
            {
                if (e.ParamsNumber == 2)
                    (e as EventsHelp<T1, T2>).Remove(action);
                else
        ...
        public void RemoveEvent<T1, T2, T3>(string eventName, Action<T1, T2, T3> action)
        {
            ...
            {
                if (e.ParamsNumber == 3)
                    (e as EventsHelp<T1, T2, T3>).Remove(action);
                else
