...
namespace EasyFramework.Edit.EditorExpand
{
    ...
    internal class TransformExpand : DecoratorEditorBase
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.BeginHorizontal();
            {
                ...
                if (GUILayout.Button(_refreshBtn, _refreshBtnStyle, GUILayout.Width(_buttonSize),
            ...
            if (((Transform)target).parent)
            {
                ...
                EditorGUILayout.LabelField(_wrold, _refreshBtnStyle, GUILayout.Width(_buttonSize),
                    GUILayout.Height(EditorGUIUtility.singleLineHeight));
