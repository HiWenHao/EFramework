...
namespace EasyFramework.Edit.Windows.PrefabsCompare
{
    public class CompareUtility
    {
        ...
        /// <returns></returns>
        private static GameObjectCompareInfo CompareGameObject(GameObject left, GameObject right, string name,
            int depth, MissType missType)
        {
            ...
            while (leftIndex < leftChildCount || rightIndex < rightChildCount)
            {
                if (leftIndex >= leftChildCount)
                {
                    for (int i = rightIndex; i < rightChildCount; i++)
                    {
                        ...
                        var childInfo = AddChildInfo(info, null, rightChild.gameObject, rightChild.name,
                            MissType.missLeft);
                ...
                else if (rightIndex >= rightChildCount)
                {
                    for (int i = leftIndex; i < leftChildCount; i++)
                    {
                        ...
                        var childInfo = AddChildInfo(info, leftChild.gameObject, null, leftChild.name,
                            MissType.missRight);
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        for (int i = rightIndex; i < index; i++)
                        {
                            ...
                            childInfo = AddChildInfo(info, null, rightChild.gameObject, rightChild.name,
                                MissType.missLeft);
                        ...
                        childInfo = AddChildInfo(info, leftChild.gameObject, rightChild.gameObject, leftChild.name,
                            MissType.allExist);
        ...
        /// <returns></returns>
        private static GameObjectCompareInfo AddChildInfo(GameObjectCompareInfo parent, GameObject left,
            GameObject right, string name, MissType missType)
        {
            ...
            while (leftIndex < leftCount || rightIndex < rightCount)
            {
                if (leftIndex >= leftCount)
                {
                    for (int i = rightIndex; i < rightCount; i++)
                    {
                        ...
                        var childInfo = AddComponentInfo(info, null, rightComponent, rightComponent.GetType().FullName,
                            MissType.missLeft);
                ...
                else if (rightIndex >= rightCount)
                {
                    for (int i = leftIndex; i < leftCount; i++)
                    {
                        ...
                        var childInfo = AddComponentInfo(info, leftComponent, null, leftComponent.GetType().FullName,
                            MissType.missRight);
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        for (int i = rightIndex; i < index; i++)
                        {
                            ...
                            childInfo = AddComponentInfo(info, null, rightComponent, rightComponent.GetType().FullName,
                                MissType.missLeft);
                        ...
                        childInfo = AddComponentInfo(info, leftComponent, rightComponent,
                            leftComponent.GetType().FullName, MissType.allExist);
        ...
        /// <param name="missType"></param>
        /// <returns></returns>
        private static ComponentCompareInfo AddComponentInfo(GameObjectCompareInfo parent, Component left,
            Component right, string name, MissType missType)
        {
        ...
        /// <param name="missType"></param>
        /// <returns></returns>
        private static ComponentCompareInfo CompareComponent(Component left, Component right, string name, int depth,
            MissType missType)
        {
