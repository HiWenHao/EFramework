 ...
 * ModifyTime:      2026-06-01 17:00:00
 * ScriptVersion:   0.7
 * ===============================================
 */
...
namespace EasyFramework.Edit
{
    ...
    public class CustomProgressWindow : EditorWindow
    {
        ...
        private const float WindowMaxWidth = 450f;
        private const float WindowMaxHeight = 160f;
        private const float WindowMinWidth = 380f;
        private const float WindowMinHeight = 130f;
        ...
        private bool _isInternalProcessing; // 是否正在处理中
        ...
        private void DrawProgressBar()
        {
            ...
            // 边框
            DrawProgressBarBorder(r, barW);
        }

        private static void DrawProgressBarBorder(Rect r, float barW)
        {
        ...
        /// <returns>true 表示成功打开；false 表示已有窗口运行中</returns>
        public static bool ShowWindow(string title, Action<bool> cancelCallback)
        {
            if (_window != null && _window._isInternalProcessing)
            {
                _window.Focus();
                return false;
            }
            ...
            _window._isInternalProcessing = true;
            ...
            _window.position = new Rect(
                mainPos.x + (mainPos.width - WindowMaxWidth) * 0.5f,
                mainPos.y + (mainPos.height - WindowMaxHeight) * 0.15f,
                WindowMaxWidth, WindowMaxHeight);
            _window.maxSize = new Vector2(WindowMaxWidth, WindowMaxHeight);
            _window.minSize = new Vector2(WindowMinWidth, WindowMinHeight);
            _window.ShowUtility();
            return true;
        }
        ...
        /// 更新进度信息。
        /// </summary>
        /// <param name="currentCount">当前已完成数量</param>
        ...
        public static void CloseWindow()
        {
            ...
            // 先清理状态再关闭，避免 OnDestroy → Cleanup 期间 _window 仍指向旧实例
            _window.Cleanup();
            _window.Close();
            _window = null;
        }
