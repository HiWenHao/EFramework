...
namespace EasyFramework.Managers.Ui
{
    public partial class UiSystem
    {
        ...
        public async UniTask<TView> OpenView<TView>() where TView : IUiView, new()
        {
            ...
            if (IsExclusiveViewType(openView.ViewType))
                ViewCloseByTypeExcept(openView.ViewType, openView);
        ...
        {
            if (uiView == null || !IsExclusiveViewType(uiView.ViewType))
                return false;
            ...
            ViewCloseByTypeExcept(uiView.ViewType, uiView);
            return true;
        }
