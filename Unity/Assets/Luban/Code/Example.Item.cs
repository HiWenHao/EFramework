...
public sealed partial class Item : Luban.BeanBase
{
    public Item(ByteBuf _buf) 
    {
        ...
        ExchangeStream = Example.ItemExchange.DeserializeItemExchange(_buf);
        {int n0 = System.Math.Min(_buf.ReadSize(), _buf.Size);ExchangeList = new System.Collections.Generic.List<Example.ItemExchange>(n0);for(var i0 = 0 ; i0 < n0 ; i0++) { Example.ItemExchange _e0;  _e0 = Example.ItemExchange.DeserializeItemExchange(_buf); ExchangeList.Add(_e0);}}
        ExchangeColumn = Example.ItemExchange.DeserializeItemExchange(_buf);
    }
